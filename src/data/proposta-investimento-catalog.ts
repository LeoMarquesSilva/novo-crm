...
export const PROPOSTA_INVESTIMENTO_TIPOS_CATALOG: InvestimentoTipoDef[] = [
  {
    ...
    subtipos: [
      ...
      inv(
        ...
        "Os honorários advocatícios para o desempenho especializado do escopo detalhado anteriormente serão fixados em R$ [VALORSPOT], já incluídos os tributos incidentes, [DETALHEPARCELAS].",
      ),
      inv(
        "spot_condicionado",
        "SPOT - Condicionado",
        "Pagamento de valor fechado referente a serviço específico, cuja execução dependerá de solicitação formal do cliente.",
        "Os honorários advocatícios para eventual execução do escopo acima descrito, mediante solicitação formal da Cliente, serão fixados em R$ [VALORSPOT], já incluídos os tributos incidentes, [DETALHEPARCELAS].",
      ),
    ],
  },
  {
